...
The ACF plot of the residuals above reveals that all of the autocorrelations are within the thereshold limits which confirms that the residuals are white noise. The high P value of **0.4611594** returned by the __portmanteau test__ futher confirms this so we will go ahead and plot forecasts for the next 10 periods.
